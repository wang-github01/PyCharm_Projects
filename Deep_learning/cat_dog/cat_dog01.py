...
#                print(character_folder, count) # 输出文件夹及图片数量
            ...
            for img in character_imgs:
                f_train.write(os.path.join(data_path, character_folder, img) + '\t' + img[0:img.index('.', 1)] + '\n') #写入地址标签
                count += 1
#                print(character_folder,count)  # 输出文件夹及图片数量